...
IDLE
  │  /task1/start
  ▼
[1] GO_TO_DOOR ───────── 机器人移动到门口
  │
  ▼
[2] ASK_GUEST1_INFO ──── 询问 guest1 姓名和想喝的饮料
  │                       产出: guest1_name, guest1_drink
  ▼
[3] GUIDE_GUEST1 ─────── 带领 guest1 到客厅
  │
  ▼
[4] POINT_EMPTY_SEAT ─── 指向预设空座，请 guest1 入座
  │
  ▼
...
[6] PICK_UP_GUEST2 ───── 到门口接 guest2
  │
  ▼
[7] DESCRIBE_GUEST1 ──── 向 guest2 描述 guest1 的外貌/衣着
  │                       需要: guest1_name
  ▼
[8] SEAT_GUEST2 ──────── 带领 guest2 到客厅入座
  │
  ▼
[9] INTRODUCE_GUESTS ─── 相互介绍两位客人
  │                       需要: guest1_name, guest2_name
  ▼
[10] REQUEST_GUEST2_BAG ─ 请求 guest2 把包放到机器人托盘上
  │
  ▼
[11] FIND_HOST ────────── 找到 host
  │
  ▼
[12] FOLLOW_HOST ─────── 跟随 host 去指定位置
  │
  ▼
[13] PLACE_BAG ────────── 将包放到指定位置
  │
  ▼
[14] TASK_COMPLETE ───── 任务完成，播报结束语
  │
  ▼
IDLE
"""
