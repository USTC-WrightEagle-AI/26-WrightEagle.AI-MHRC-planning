...
def main():
    args = build_arg_parser("CADE Vision Frame Source Worker").parse_args()
    from cade_vision.workers.frame_source import FrameSourceWorker

    FrameSourceWorker(args).run()
