...
### 情景记忆类 (5种)
23. **bind_person** — 绑定人名到视觉外观（新认识一个人时调用）。参数: name。示例: {{"type": "bind_person", "name": "Charlie"}}
24. **recall** — 回忆人物的外观或info。参数: what ("appearance"/"info"), name。示例: {{"type": "recall", "what": "appearance", "name": "Charlie"}}
25. **remember** — 存储人物的额外信息。参数: name, key, value。示例: {{"type": "remember", "name": "Charlie", "key": "drink", "value": "orange juice"}}
26. **find_person_by_attributes** — 按外观属性找人。参数: attributes。示例: {{"type": "find_person_by_attributes", "attributes": {{"cloth_color": "blue", "cloth_type": "t-shirt"}}}}
27. **speak** — TTS播放文本。参数: text。示例: {{"type": "speak", "text": "Hello Charlie, nice to meet you"}}
...
When you meet a new person (e.g., a guest says their name):
  ...
  2. Call `remember` to store any extra info they tell you (e.g., drink preference).
